...
A web app where users can search for books, create a club, invite other users, and start discussions within the club about a specific book.

Focus Areas: Build a separate frontend and backend, agile project workflow, implement authentication via OAuth
